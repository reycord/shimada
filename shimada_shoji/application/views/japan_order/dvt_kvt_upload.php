        ...
        <div class="x_panel">
            <div class="x_title">
							...
							<ul class="nav navbar-right panel_toolbox">
									<li><button type="button" id="btnPvUpload" data-toggle="modal" data-target="#pv_upload_modal" class="btn btn-success"><i class="fa fa-cloud-upload"></i> <?php echo $this->lang->line('upload_dvt_kvt'); ?> </button>
									</li>
							</ul>
            ...
            <div class="x_content">
                <div class="panel panel-default">
                  <div class="panel-body">
                    <form id="order_received_pv_upload_form" class="form-horizontal myform" action="<?php echo base_url(); ?>japan_order/do_dvt_kvt_upload" method="post" enctype="multipart/form-data">
                      <div class="form-group">
                        <div class="col-sm-12" >
                          <label class="control-label col-sm-2 form-title" for="pv_file" ><?php echo $this->lang->line('dvt_kvt_file'); ?><span class="required">*</span></label>
