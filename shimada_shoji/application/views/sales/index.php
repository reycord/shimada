        ...
        <div class="x_panel">
            <div class="x_title">
                ...
                <ul class="nav navbar-right panel_toolbox">
                    <li>
                        <form action="<?php echo base_url() ?>sales/japan_order_excel" method="GET" id="form_export_excel">
...
<script>
    ...
    window.onload = function()
    {
        ...
        var saleDt = $('#sales_list').DataTable({
            ...
            "ajax": { 
                "url": "<?php echo base_url('sales/searchDVT1'); ?>",
                "type": 'post',
                "data": function ( data ) {
                    data.param = {};
        ...
        $('#search_sales').on('click', function(){
			...
			// delivery_date_from = new Date(delivery_date_from);
			// delivery_date_to = new Date(delivery_date_to);
		
			// // compare create date to vs create date from
			// if(delivery_date_to < delivery_date_from) {
			// 	$('.err-msg[field=order_date_to]').html('Delivery date from > Delivery date to!');
			// 	return;
			// }
