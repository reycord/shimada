    ...
    if(!function_exists("generatePrintLineByListItem")){
        function generatePrintLineByListItem($items, $data){
            ...
            foreach($items as $index => $item){
                ...
                $itemStr .= str_repeat(" ",5).str_pad($packages.($packages > 1 ? "PACKAGES":"PACKAGE"),33);
                ...
                foreach($sizeColorArray as $i=> $sizeColor){
                    ...
                    $size = str_repeat(" ",16).str_pad(($sCl[0] != '' && $sCl[0] != null ? 'SIZE: '.str_pad($sCl[0]. $item['size_unit'],4," ",STR_PAD_LEFT) : ''), 13," ", STR_PAD_LEFT).str_pad(($sCl[1] != '' && $sCl[1] != null ? 'COL.' . str_pad($sCl[1],4," ", STR_PAD_LEFT) : ''), 13," ", STR_PAD_LEFT).str_pad(number_format($sCl[2], 2) . " " . $item['unit'], 13," ", STR_PAD_LEFT);
...
<body>
  <div class="book">
<?php foreach($print_type as $type): ?>
    <!-- Cover page -->
    <?php if(count($data['delivery_no'])>1): ?>
    <div class="page">
        <div class="container">
            <div class="row" style="margin-top: 1mm">
                <div class="col-8 nopadding text-content">
                    ...
                    <h5 class="address col-12 nopadding  no-float">
                        <?php echo str_replace("\n","<br>",$data['header_address']) ?>
                    </h5>
                </div>
                <div class="col-4">
            ...
            <div class="row">
                ...
                <div class="col-4"><h5><?php echo $data["consigned_name"]; echo '<br>'.str_replace("\n","<br>",$data["consigned_to"]) ?></h5></div>
            </div>
            <div class="row">
            ...
            <div class="row">
                <div class="col-8 nopadding txt-black">
                    <h5>CONT: <?php echo $data['contract_no_pl'] ?></h5>
                </div>
            </div>
            <div class="row">
                <div class="col-8 nopadding txt-black">
                    <h5>INV: <?php echo $data['invoice_no_excel'] ?></h5>
                </div>
            </div>
            <div class="row">
                <div class="col-8 nopadding txt-black">
                    <h5>NO. <?php echo implode(", ", array_map("trim",$data['delivery_no'])) ?></h5>
                </div>
            </div>
            <div class="row">
            ...
            <?php elseif($type=="delivery_note"): ?>
                ...
                <div class="row">
                    <div class="col-4"><h>----------------------------------------</h5></div>
                    <div class="col-4 col-offset-2"><h5>----------------------------------------</h5></div>
                </div>
            <?php elseif($type=="inv_del_voucher"): ?>    
                <div class="row" style="margin-top:20px">
            ...
            <?php foreach($printPages as $item=> $print): ?>
                <div class="page">
                    <div class="container">
                        ...
                        <div class="row">
                            <div class="col-8 nopadding txt-black">
                                <h5 style="margin-left: 40px;"><?php echo $delivery['delivery_no'] ?></h5>
                                INV:<span style="margin-left: 10px;"><?php echo $data['invoice_no_excel'] ?></span>
                            </div>
                        </div>
                        <div class="row">
