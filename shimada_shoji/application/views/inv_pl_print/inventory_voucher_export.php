        ...
        <div class="page" style="page-break-before: auto;">
            <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-4"><h5> <?php echo ($delivery["consignee"] != null && $delivery["consignee"] != '')? $delivery["consignee"] : $delivery['pack_consigned_to'] ?></h5></div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-8 nopadding txt-black">
                        <h5>INV: <?php echo implode(",", $delivery['invoice_no']) ?></h5>
                    </div>
                </div>
                <div class="row">
                    <div class="col-8 nopadding txt-black">
                        <h5>NO. <?php echo $delivery['delivery_no'] ?></h5>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <?php
                        ...
                        $total = str_repeat("=",80);
                        $total .= "\n";
                        $total .= str_pad("TOTAL".str_repeat(" ",5).$delivery['total_package']."PACKAGES",56);
                        $total .= $delivery['total_netwt']."KG".str_repeat(" ",3)
                                .$delivery['total_grosswt']."KG".str_repeat(" ",3)
                                .$delivery['total_measurem'];
                        $total .= "\n";
                        if(is_array($delivery['total_unit'])) {
                          foreach ($delivery['total_unit'] as $key => $value) {
                              $total .= str_repeat(" ",22).$value.' '.$key;
                              $index ++;
                              if($index !== count($delivery['total_unit'])){
                              $total .= "\n";
                              }
                          }
                        } else {
                            $total .= str_repeat(" ",22).$delivery['total_quantity'];
                        }
                        $total .= "\n";
                        $total .= str_repeat("=",80);
                    ?>
            ...
            <div class="container">
                <div class="row" style="margin-top: 1mm">
                    <div class="col-6 nopadding text-content">
                        <h5 class="address-company-name"><?php echo $data['header_name'] ?></h5>
                        <h5 class="address col-10 nopadding  no-float">
                            DATE: <?php echo $delivery['delivery_date'] ?>
                        </h5>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row" style="width:90%">
                    <?php foreach ($delivery['pack'] as $pack): ?>
                        <?php if($pack['case_mark'] != ''): ?>
                    ...
                    <div class="container">
                        <div class="row" style="margin-top: 1mm">
                            ...
                            <div class="col-4 col-offset-2">
                                ...
                                <h5 class=""><?php echo $pack['case_mark'] ?></h5>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-8 nopadding txt-black">
